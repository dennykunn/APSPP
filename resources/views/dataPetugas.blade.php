...
<div class="col-span-5 p-3 bg-gray-200">
    <div class="flex justify-between items-center">
        <div class="flex items-end">
            <h1 class="text-2xl mr-2">Petugas</h1>
    ...
    <div class="bg-white p-2 rounded-md border-t-4 border-purple-500">
        <div class="flex justify-between">
            ...
            <div class="flex items-center ">
                <input class="border-y-2 rounded-full border-l-2 outline-none border-purple-500 pl-3 pr-10 py-[2px]" type="text" placeholder="NIS Siswa">
                <button class="py-1 px-2 -ml-[38px] border-2  rounded-full bg-purple-500 border-purple-500">
