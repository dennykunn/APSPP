@extends('layoutForm')
@section('konten')
<form class="bg-white w-[400px] p-12 shadow-md rounded-lg">
    <div class="flex flex-col items-center mb-8">
        <h1 class="text-xl font-semibold mb-1">LOGIN SISWA</h1>
    ...
    <div class="flex flex-col items-center text-center mt-12">
        ...
        <a class="text-sm text-rose-500 my-2 hover:underline underline-offset-4" href="\">Kembali?</a>
        <small>Jika anda belum memiliki akun silahkan <a class="hover:underline underline-offset-4 text-rose-500" href="\register"><b>Register</b></a> terlebih dahulu</small>
    </div>
</form>
@endsection